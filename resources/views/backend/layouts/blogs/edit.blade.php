                        ...
                        <form method="POST" action="{{ route('admin.blogs.update', $data->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="input-style-1 mt-4">
                                ...
                                <textarea name="sub_description" id="sub_description" class="form-control @error('sub_description') is-invalid @enderror"
                                    placeholder="Enter Sub Description" value="{{ old('sub_description') }}" rows="5">{{  $data->sub_description ?? '' }}</textarea>
                            ...
                            <div class="input-style-1 mt-4">
                                ...
                                <textarea name="description" id="page_content" class="form-control @error('description') is-invalid @enderror"
                                    placeholder="Enter Description" value="{{ old('description') }}" rows="7">{{ $data->description ?? '' }}</textarea>
                                @error('description')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="input-style-1 mt-4">
                                ...
                                <input type="file" placeholder="Enter Image" id="image"
                                    class="dropify form-control @error('image') is-invalid @enderror" name="image" data-default-file="{{ asset( $data->image ?? 'backend/images/placeholder/image_placeholder.png') }}" />
